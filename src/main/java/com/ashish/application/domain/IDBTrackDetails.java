...
public class IDBTrackDetails implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = "companyCodes", allowSetters = true)
    private IDBCompanyDetails companyCode;
    ...
    public IDBCompanyDetails getCompanyCode() {
        return companyCode;
    }

    public IDBTrackDetails companyCode(IDBCompanyDetails iDBCompanyDetails) {
        this.companyCode = iDBCompanyDetails;
        return this;
    }

    public void setCompanyCode(IDBCompanyDetails iDBCompanyDetails) {
        this.companyCode = iDBCompanyDetails;
    }
