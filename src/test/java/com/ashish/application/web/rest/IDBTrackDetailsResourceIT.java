...
public class IDBTrackDetailsResourceIT {
    ...
    @Autowired
    private IDBTrackDetailsService iDBTrackDetailsService;
    ...
    public void createIDBTrackDetails() throws Exception {
        ...
        IDBTrackDetailsDTO iDBTrackDetailsDTO = iDBTrackDetailsMapper.toDto(iDBTrackDetails);
        restIDBTrackDetailsMockMvc.perform(post("/api/idb-track-details")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(iDBTrackDetailsDTO)))
    ...
    public void updateIDBTrackDetails() throws Exception {
        ...
        updatedIDBTrackDetails
            ...
            .executingDepartment(UPDATED_EXECUTING_DEPARTMENT)
            .companyName(UPDATED_COMPANY_NAME);
        IDBTrackDetailsDTO iDBTrackDetailsDTO = iDBTrackDetailsMapper.toDto(updatedIDBTrackDetails);
